...
#import "ViewControllerRaspadinha.h"

#define RandomNumber(min, max) min + arc4random_uniform(max - min + 1)

@interface ViewControllerRaspadinha ()
...
@implementation ViewControllerRaspadinha
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    //[collectionViewMenu.collectionViewLayout invalidateLayout];
    //[collectionViewMenu.collectionViewLayout prepareLayout];
